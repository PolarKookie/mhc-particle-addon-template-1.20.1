...
public class ColorableSonicBoom extends AbstractDustParticle<ColorableSonicBoomEffect> {
    private final Vector3f startColor;
    private final Vector3f endColor;

    protected ColorableSonicBoom(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, ColorableSonicBoomEffect parameters, SpriteProvider spriteProvider) {
    ...
    @Environment(EnvType.CLIENT)
    public static class Factory implements ParticleFactory<ColorableSonicBoomEffect> {
        ...
        public Particle createParticle(
                ColorableSonicBoomEffect ColorableSonicBoomEffect, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i
        ) {
            return new ColorableSonicBoom(clientWorld, d, e, f, g, h, i, ColorableSonicBoomEffect, this.spriteProvider);
        }
    }
}
